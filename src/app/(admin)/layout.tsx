...
export default async function AdminLayout({
  ...
  const navItems = [
    ...
    { href: '/students', label: 'Students Directory', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    ...
    { href: '/subject-assignments', label: 'Faculty Class Allocations', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
    ...
    { href: '/roster', label: 'People & Class Data', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' },
      ...
      <aside className="w-full md:w-64 sidebar-light p-5 flex flex-col justify-between md:sticky md:top-0 md:h-screen md:overflow-y-auto">
        <div>
          ...
          <div className="flex items-center gap-3 pb-5 border-b border-gray-100 mb-5">
            ...
            <div>
              <span className="font-semibold text-sm text-gray-900 block">MRECMS Admin</span>
              <span className="text-[10px] text-violet-600 font-medium uppercase tracking-wider">HoD & Administrator</span>
            </div>
          </div>
        ...
        {/* User Card */}
        <div className="pt-5 border-t border-gray-100 mt-6 flex items-center justify-between text-sm">
          <div className="overflow-hidden pr-2">
            <p className="font-semibold text-gray-900 truncate text-xs">{user.fullName}</p>
            <p className="text-[10px] text-violet-600 font-medium truncate">{user.email}</p>
          </div>
          <SignOutButton
